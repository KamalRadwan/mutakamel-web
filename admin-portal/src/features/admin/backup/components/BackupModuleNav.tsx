      ...
      <div className="w-full px-4 pt-4 sm:pt-5">
        <div className="flex flex-col gap-3 pb-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex min-w-0 items-center gap-3">
            <div className="flex size-10 shrink-0 items-center justify-center rounded-md border border-border bg-ink-100 text-foreground dark:bg-ink-900/60">
              <DatabaseBackup className="size-5" aria-hidden="true" />
            </div>
            <div className="min-w-0">
              <p className={`text-2xs font-semibold text-muted-foreground ${lang === "en" ? "uppercase tracking-[0.16em]" : ""}`}>
                {t.backup.eyebrow}
              </p>
              <div className="flex flex-wrap items-baseline gap-x-2 gap-y-1">
                <p className="text-lg font-semibold tracking-tight text-foreground">{t.backup.title}</p>
                <span className="rounded-full border border-border bg-ink-50 px-2 py-0.5 text-xs font-semibold text-muted-foreground dark:bg-ink-900">
