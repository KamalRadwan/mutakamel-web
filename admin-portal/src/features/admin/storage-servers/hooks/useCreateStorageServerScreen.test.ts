    ...
    t: {
      createStorageServer: {
        ...
        activation: {
          ...
          setupCompleteDescription: "Saved, checked, and activated.",
          recoveryMessageWithAccess: "Inspect its current lifecycle state.",
          recoveryMessageNoAccess: "Resolve the rejection and retry activation only.",
          needsAttentionTitle: "Saved; activation needs attention",
          ambiguousOutcomeMessage: "Activation is still unknown.",
        },
      },
    },
  }),
