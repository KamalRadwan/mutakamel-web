export const ar = {
  ...
  applications: {
    ...
    technicalProvisioning: {
      ...
      bindingCalloutDescription: "أرسل مفتاح المكوّن القياسي صراحةً. يحتفظ Core بهدف التشغيل المخزّن كمرجع ولا يقبل محتوى قابلاً للتنفيذ.",
      ...
      bindingDescription: "أدخل هوية المكوّن القياسية وراجع هدف التشغيل المرجعي من الخادم، ثم سجّل إصدار العقد وسبب العملية.",
