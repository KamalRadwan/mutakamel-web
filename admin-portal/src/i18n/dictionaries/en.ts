...
export const en: Dictionary = {
  ...
  applications: {
    ...
    detail: {
      ...
      delete: "Delete",
      activationBlocked: "Complete technical provisioning before activation.",
    ...
    technicalProvisioning: {
      ...
      noCredential: "Worker routing is derived. No password, secret, SQL, or migration body is exposed.",
      checks: {
      ...
      bindingCalloutDescription: "Create the controlled Application-to-Worker mapping. Core derives immutable keys and does not accept executable content.",
      ...
      bindingDescription: "Review the server-derived routing identity, then record a contract version and audit reason.",
      closeDialog: "Close component binding dialog",
      derivedMapping: "Derived immutable mapping",
