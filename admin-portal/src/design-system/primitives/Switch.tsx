...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ref={ref}
    className={cn(
      "peer inline-flex h-5 w-9 shrink-0 items-center rounded-full border border-input bg-muted transition-colors motion-reduce:transition-none",
  ...
  >
    ...
    <SwitchPrimitive.Thumb
      className={cn(
        "pointer-events-none block size-4 rounded-full bg-primary-foreground shadow-pop ring-0 transition-transform motion-reduce:transition-none",
