  ...
  return (
    ...
    >
      ...
      <main className="grid flex-1 place-items-center p-6">
        <section className="w-full max-w-xl rounded-3xl border border-violet-200 bg-white p-8 text-center shadow-lg dark:border-violet-900 dark:bg-slate-950">
          <AppWindow className="mx-auto size-10 text-violet-600" aria-hidden="true" />
          <h1 className="mt-4 text-xl font-black">{copy.title}</h1>
          ...
          <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
            <button
              ...
              className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-violet-600 px-5 text-sm font-bold text-white hover:bg-violet-500"
            >
            ...
            <Link
              href="/dashboard"
              className="inline-flex min-h-11 items-center justify-center rounded-xl border border-slate-200 px-5 text-sm font-bold hover:bg-slate-100 dark:border-slate-700 dark:hover:bg-slate-800"
            >
              {copy.dashboard}
            </Link>
          </div>
...
function ApplicationsCatalogueContent() {
  ...
  return (
    <div dir={dir} className="min-h-screen bg-slate-50 dark:bg-[#090d16] text-slate-900 dark:text-slate-100 flex flex-col">
      <Navbar />
          ...
          <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-5">
            ...
            {canReadAudit && (
              <Link
                ...
                className="flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-4 py-2.5 text-xs font-bold text-white hover:bg-white/15"
              >
  ...
  return (
    <label className="text-[10px] font-bold uppercase tracking-wider text-slate-500">
      ...
      <select
        ...
        className="w-full rounded-xl border border-slate-200 bg-slate-50 px-2.5 py-2.5 text-[11px] font-bold normal-case tracking-normal text-slate-700 outline-none focus:border-amber-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200"
      >
        {options.map((option) => (
