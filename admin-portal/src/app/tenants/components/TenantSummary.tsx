...
export function TenantSummary({ metrics }: TenantSummaryProps) {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 sm:gap-4">
      {/* Total Tenants */}
      <div className="relative overflow-hidden bg-white dark:bg-slate-900/90 p-4 rounded-2xl border border-slate-200/80 dark:border-blue-500/20 shadow-sm hover:shadow-md transition-all">
        <div className="absolute top-0 end-0 w-20 h-20 bg-blue-500/10 rounded-full blur-xl pointer-events-none" />
        <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
          <span className="text-xs font-bold uppercase tracking-wider">{t.tenants.totalTenants}</span>
      ...
      <div className="relative overflow-hidden bg-white dark:bg-slate-900/90 p-4 rounded-2xl border border-slate-200/80 dark:border-emerald-500/20 shadow-sm hover:shadow-md transition-all">
        ...
        <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
          <span className="text-xs font-bold uppercase tracking-wider">{t.tenants.activeTenants}</span>
          <div className="p-1.5 bg-emerald-50 dark:bg-emerald-950/50 text-emerald-600 dark:text-emerald-400 rounded-lg">
            <CheckCircle2 className="w-4 h-4" />
          </div>
        </div>
        <div className="text-2xl font-black text-emerald-600 dark:text-emerald-400 font-mono mt-1 flex items-center gap-2">
          {metrics.active}
      ...
      {/* Provisioning Queue */}
      <div className="relative overflow-hidden bg-white dark:bg-slate-900/90 p-4 rounded-2xl border border-slate-200/80 dark:border-cyan-500/20 shadow-sm hover:shadow-md transition-all">
        <div className="absolute top-0 end-0 w-20 h-20 bg-cyan-500/10 rounded-full blur-xl pointer-events-none" />
        <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
          <span className="text-xs font-bold uppercase tracking-wider">{t.tenants.provisioningQueue}</span>
      ...
      {/* Suspended Tenants */}
      <div className="relative overflow-hidden bg-white dark:bg-slate-900/90 p-4 rounded-2xl border border-slate-200/80 dark:border-amber-500/20 shadow-sm hover:shadow-md transition-all">
        <div className="absolute top-0 end-0 w-20 h-20 bg-amber-500/10 rounded-full blur-xl pointer-events-none" />
        <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
          <span className="text-xs font-bold uppercase tracking-wider">{t.tenants.suspendedTenants}</span>
      ...
      {/* Failed Provisioning */}
      <div className="relative overflow-hidden bg-white dark:bg-slate-900/90 p-4 rounded-2xl border border-slate-200/80 dark:border-rose-500/20 shadow-sm hover:shadow-md transition-all col-span-2 sm:col-span-1">
        <div className="absolute top-0 end-0 w-20 h-20 bg-rose-500/10 rounded-full blur-xl pointer-events-none" />
        <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
          <span className="text-xs font-bold uppercase tracking-wider">{t.tenants.failedTenants}</span>
