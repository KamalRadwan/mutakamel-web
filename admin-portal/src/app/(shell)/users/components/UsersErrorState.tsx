...
export function UsersErrorState({
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-8 text-center shadow-2xs space-y-4 max-w-lg mx-auto my-8">
