...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-canvas text-slate-900 dark:text-slate-100 flex flex-col justify-between p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md mx-auto my-auto py-8 z-10">
        <div className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800/80 rounded-xl shadow-2xl p-6 sm:p-8 space-y-6">
          {/* Header & Titles */}
          <div className="text-center space-y-2">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-tr from-blue-700 to-blue-500 text-white shadow-lg shadow-blue-500/30 mb-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300 block text-start">
                {t.login.emailLabel}
              </label>
            ...
            <button
              ...
              className="w-full py-3 px-4 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 rounded-xl shadow-lg shadow-blue-600/25 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:cursor-not-allowed mt-2"
            >
              {isSubmitting ? (
                <>
      ...
      {/* Footer Note */}
      <div className="w-full text-center text-xs text-slate-400 z-10">
      ...
      {isForgotModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-xs">
          <div className="w-full max-w-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-2xl p-6 space-y-4">
            ...
            <form onSubmit={handleForgotPassword} className="space-y-3">
                ...
                <div className="flex items-center justify-end gap-2 pt-2">
                  ...
                  <button
                    type="submit"
                    className="px-3 py-1.5 text-xs font-semibold bg-blue-600 text-white rounded-lg shadow-sm hover:bg-blue-700"
                  >
                    إرسال رابط التعيين
                  </button>
                </div>
