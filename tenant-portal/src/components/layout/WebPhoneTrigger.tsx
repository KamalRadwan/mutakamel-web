...
export function WebPhoneTrigger(props: UseWebPhoneTriggerProps) {
  ...
  return (
    <button
      ...
      type="button"
      className="relative p-1.5 rounded-lg text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer group"
      title={title}
    >
      ...
      <span className="absolute bottom-1 end-1 flex h-1.5 w-1.5">
        <span
