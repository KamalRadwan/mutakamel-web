...
export default function SourceSettingsPage() {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 space-y-6 max-w-xl">
      <h2 className="text-base font-bold text-slate-900 dark:text-slate-100">{t.crm.uTMTrackingAndAutoLinkSet}</h2>
      <Input label={t.crm.uTMCampaignID} defaultValue="google_ads_search_2026" />
