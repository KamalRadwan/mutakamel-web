...
const historyLogs = [
  ...
  { id: 2, action: "I18N_FALLBACK", user: "I18N_FALLBACK", timestamp: "2026-07-10 11:30:00" },
];

export default function PresetHistoryPage() {
    const { t } = useI18n();
  const columns = [
    { header: t.crm.modificationSetting, accessorKey: "action" as const },
  ...
  return (
    <div className="space-y-4">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4">
        <h2 className="text-base font-bold text-slate-900 dark:text-slate-100">{t.crm.recordChangesToThePreAnal}</h2>
      </div>
