...
const SCOPES = [
  ...
  { area: "CRM activities", dir: "crm-app/src/crm/activities" },
  { area: "CRM notes & attachments", dir: "crm-app/src/crm/notes-attachments" },
  { area: "CRM outbound email", dir: "crm-app/src/crm/outbound-emails" },
  { area: "CRM dashboards", dir: "crm-app/src/crm/dashboards" },

  { area: "Authentication & session", dir: "core-app/src/tenant/tenant-auth" },
  { area: "Notifications", dir: "core-app/src/tenant/notifications" },
  { area: "Organization", dir: "core-app/src/tenant/organization" },
  { area: "Users", dir: "core-app/src/tenant/tenant-users" },
  { area: "Roles", dir: "core-app/src/tenant/tenant-roles" },
  { area: "Scope role assignments", dir: "core-app/src/tenant/scope-role-assignments" },
  { area: "User modules", dir: "core-app/src/tenant/user-modules" },
  { area: "Workspace settings", dir: "core-app/src/tenant/workspace-settings" },
  { area: "Currencies", dir: "core-app/src/tenant/currencies" },
  { area: "Taxes", dir: "core-app/src/tenant/taxes" },
  { area: "Numbering sequences", dir: "core-app/src/tenant/numbering-sequences" },
  { area: "Email configuration", dir: "core-app/src/tenant/email-config" },
  { area: "Billing", dir: "core-app/src/tenant/billing" },
  { area: "Subscription", dir: "core-app/src/tenant/subscription" },
  { area: "Payments", dir: "core-app/src/tenant/payments" },
  { area: "Branding", dir: "core-app/src/tenant/branding" },
  { area: "Directory", dir: "core-app/src/tenant/directory" },
  { area: "Templates", dir: "core-app/src/tenant/template-platform" },
  { area: "Audit", dir: "core-app/src/tenant/audit" },
  { area: "Core activities", dir: "core-app/src/tenant/activities" },

  { area: "Trade catalog", dir: "trade-app/src/modules/catalog" },
  { area: "Trade commercial accounts", dir: "trade-app/src/modules/commercial-accounts" },
  { area: "Trade configuration", dir: "trade-app/src/modules/configuration-scope" },
  { area: "Trade documents", dir: "trade-app/src/modules/documents" },
  { area: "Trade financial documents", dir: "trade-app/src/modules/financial-documents" },
  { area: "Trade purchasing", dir: "trade-app/src/modules/purchasing" },
  { area: "Trade purchase quotations", dir: "trade-app/src/modules/purchase-quotations" },
  { area: "Trade inventory", dir: "trade-app/src/modules/inventory" },
  { area: "Trade pricing", dir: "trade-app/src/modules/pricing" },
  { area: "Trade policy studio", dir: "trade-app/src/modules/policy-studio" },
  { area: "Trade dashboards", dir: "trade-app/src/modules/dashboards" },
  { area: "Trade document platform", dir: "trade-app/src/modules/document-platform" },
  { area: "Trade extensions & automation", dir: "trade-app/src/modules/extensions-automation" },
  { area: "Trade control tower", dir: "trade-app/src/modules/control-tower" },
];
